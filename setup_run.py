...
ifiles.setup_input_files(op.join(input_dir,"base","input_file_rep"), op.join(folder,"base","input_file_rep_start")     ,newinfofile)
ifiles.setup_input_files(op.join(input_dir,"base","input_file_rep"), op.join(folder,"base","input_file_rep_start_cont"),newinfofile)
ifiles.setup_input_files(op.join(input_dir,"base","input_file_rep"), op.join(folder,"base","input_file_rep_cont")      ,newinfofile)
ifiles.setup_input_files(op.join(input_dir,"base","input_file_rep"), op.join(folder,"base","input_file_rep_fxa")       ,newinfofile)
